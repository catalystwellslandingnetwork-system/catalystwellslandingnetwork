                ...
                <div className="grid lg:grid-cols-3 gap-6 sm:gap-7 lg:gap-8 mb-12 sm:mb-16 lg:mb-20">
                    {pricingPlans.map((plan, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`group relative ${plan.popular ? 'sm:-mt-4 lg:-mt-8' : ''
                                    }`}
                            >
                                {/* Badge */}
                                {plan.badge && (
                                ...
                                {/* Card */}
                                <div className={`relative glass-dark rounded-2xl sm:rounded-3xl p-6 sm:p-7 lg:p-8 border active:scale-[0.98] transition-all duration-500 touch-manipulation ${plan.popular
                                    ...
                                    <Link
                                        ...
                                        className={`block w-full py-3.5 sm:py-4 rounded-xl font-semibold transition-all mb-6 sm:mb-8 relative overflow-hidden group/btn active:scale-95 touch-manipulation ${plan.popular
                                                ? ''
                                    ...
                                    >
                                        ...
                                        <span className={`relative z-10 flex items-center justify-center space-x-2 text-sm sm:text-base ${plan.popular ? 'text-white' : 'text-gray-300 group-hover/btn:text-white'
                                            }`}>
